...
const activeAccounts=data.filter((data)=> data.isActive);
console.log(activeAccounts);
console.log("========================================");
const highestBalance=data.map((data)=>data.balance)
                        .reduce((acc,balance)=>acc>balance ? acc:balance);
console.log("The highest balance is:")
console.log(highestBalance);
console.log("========================================");
const friends = data.map((data=> data.friends));
console.log(friends);
console.log("The names of friends are as:")
console.log("========================================");
const accHoldersName=data.map((data)=>data.name).join(",");
console.log("The Account Holder's names are as:")
console.log(accHoldersName);